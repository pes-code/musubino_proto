...
$sql = "UPDATE will_table SET fullcode=:fullcode, dnar=:dnar, bsc=:bsc, handsonly=:handsonly, other=:other, message=:message, date=:date, name=:name, evidence=:evidence, updated_at=now() WHERE id=:id";
